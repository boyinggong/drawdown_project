...
pos_example = as.vector(arima.sim(model = list(ar=0.7), n = 100, 
                                  rand.gen = function(n) rnorm(n, sd = 0.01)))
neg_example = as.vector(arima.sim(model = list(ar=-0.7), n = 100, 
                                  rand.gen = function(n) rnorm(n, sd = 0.01)))
...
plot_grid(ggplot(data.frame(x = 1:100, 
  ...
  ggplot(data.frame(x = 1:100, 
    ...
    geom_line() + theme_light() + ylim(0.5, 1.5) + ylab("Price") + xlab("Time"),
  ggplot(data.frame(x = 1:100, 
...
calc_ar2_sd = function(ts.param.ar2){
  return(sqrt(0.0001 / (1-ts.param.ar2["AR1"]^2-ts.param.ar2["AR2"]^2-
                          2*ts.param.ar2["AR1"]^2*ts.param.ar2["AR2"]/(1-ts.param.ar2["AR2"]))))
}
...
png("../figures/simulation/AR1_adjsd.png", width = 400, height = 200)
ggplot(sim.risk.ar.1.adjsd, aes(x = ts.param.ar.1, y = CED)) + geom_point() + theme_bw() + 
  xlab(expression(rho[1]))
dev.off()
...
plot_grid(ggplot(data.frame(cbind(ts.param.ar2, sim.risk.ar.2.adjsd)), 
                 aes(x = ac1, y = ES, group = factor(ac2))) + geom_point(aes(colour = ac2)) + theme_light() +
            xlab(expression(rho[1])) +
            scale_colour_gradient2(high="steelblue", mid="darksalmon") ,
          ggplot(data.frame(cbind(ts.param.ar2, sim.risk.ar.2.adjsd)), 
                 aes(x = ac1, y = VaR, group = factor(ac2))) + geom_point(aes(colour = ac2)) + theme_light() +
            xlab(expression(rho[1])) +
            scale_colour_gradient2(high="steelblue", mid="darksalmon"),
          ggplot(data.frame(cbind(ts.param.ar2, sim.risk.ar.2.adjsd)), 
                 aes(x = ac1, y = sd, group = factor(ac2))) + geom_point(aes(colour = ac2)) + theme_light() +
            xlab(expression(rho[1])) + ylab("Volatility") + 
            scale_colour_gradient2(high="steelblue", mid="darksalmon"),
          ggplot(data.frame(cbind(ts.param.ar2, sim.risk.ar.2.adjsd)), 
                 aes(x = ac1, y = CED, group = factor(ac2))) + geom_point(aes(colour = ac2)) + theme_light() +
            xlab(expression(rho[1])) +
            scale_colour_gradient2(high="steelblue", mid="darksalmon"),
          ncol = 2, align = 'v')

png("../figures/simulation/AR2_adjsd.png", width = 400, height = 200)
ggplot(data.frame(cbind(ts.param.ar2, sim.risk.ar.2.adjsd)), 
...
png("../figures/simulation/MA1_adjsd.png", width = 400, height = 200)
ggplot(data.frame(cbind(sim.risk.ma.1.adjsd, sim.ma.1.acf)), 
       aes(x = ac1, y = CED)) + geom_point() + theme_bw() + 
  xlab(expression(rho[1]))
dev.off()
...
plot_grid(ggplot(data.frame(cbind(ts.param.ma2, sim.risk.ma.2.adjsd)), 
          ...
          ggplot(data.frame(cbind(ts.param.ma2, sim.risk.ma.2.adjsd)), 
            ...
            scale_colour_gradient2(high="steelblue", mid="darksalmon"),
          ggplot(data.frame(cbind(ts.param.ma2, sim.risk.ma.2.adjsd)), 
                 aes(x = ac1, y = CED, group = factor(MA2))) + geom_point(aes(colour = MA2)) + theme_light() +
            xlab(expression(rho[1])) +
            scale_colour_gradient2(high="steelblue", mid="darksalmon"),
          ncol = 2, align = 'v')
...
png("../figures/simulation/MA2_adjsd.png", width = 400, height = 200)
ggplot(data.frame(cbind(ts.param.ma2, sim.risk.ma.2.adjsd)), 
       aes(x = ac1, y = CED, group = factor(MA2))) + geom_point(aes(colour = MA2)) + theme_light() +
  xlab(expression(rho[1])) +
  scale_colour_gradient2(high="steelblue", mid="darksalmon")
...
plot_grid(ggplot(data.frame(cbind(sim.risk.ar1.ma1.adjsd, ts.param.ar1.ma1)), 
                 aes(x = ac1, y = ES, group = factor(ac2))) + geom_point(aes(colour = ac2)) + theme_light() +
            xlab(expression(rho[1])) +
            scale_colour_gradient2(mid="steelblue", low="darksalmon") ,
          ggplot(data.frame(cbind(sim.risk.ar1.ma1.adjsd, ts.param.ar1.ma1)), 
                 aes(x = ac1, y = VaR, group = factor(ac2))) + geom_point(aes(colour = ac2)) + theme_light() +
            xlab(expression(rho[1])) +
            scale_colour_gradient2(mid="steelblue", low="darksalmon"),
          ggplot(data.frame(cbind(sim.risk.ar1.ma1.adjsd, ts.param.ar1.ma1)), 
...
plot_grid(ggplot(data.frame(cbind(sim.risk.ar1.ma1.adjsd, ts.param.ar1.ma1)), 
          ...
          ggplot(data.frame(cbind(sim.risk.ar1.ma1.adjsd, ts.param.ar1.ma1)), 
            ...
            scale_colour_gradient2(mid="steelblue", low="darksalmon"),
          ggplot(data.frame(cbind(sim.risk.ar1.ma1.adjsd, ts.param.ar1.ma1)), 
                 aes(x = ac1, y = CED, group = factor(MA1))) + geom_point(aes(colour = MA1)) + theme_light() +
            xlab(expression(rho[1]))+ 
            scale_colour_gradient2(mid="steelblue", low="darksalmon"),
          ncol = 2, align = 'v')

png("../figures/simulation/ARMA11_adjsd.png", width = 400, height = 200)
ggplot(data.frame(cbind(sim.risk.ar1.ma1.adjsd, ts.param.ar1.ma1)), 
       aes(x = ac1, y = CED, group = factor(MA1))) + geom_point(aes(colour = MA1)) + theme_light() +
  xlab(expression(rho[1]))+ 
  scale_colour_gradient2(mid="steelblue", low="darksalmon")
...
subset_AR2 = which(abs(ts.param.ar2["AR1"]) <= 0.5 & abs(ts.param.ar2["AR2"]) <= 0.5)
subset_MA2 = which(abs(ts.param.ma2["MA1"]) <= 0.5 & abs(ts.param.ma2["MA2"]) <= 0.5)
subset_ARMA11 = which(abs(ts.param.ar1.ma1["AR1"]) <= 0.5 & abs(ts.param.ar1.ma1["MA1"]) <= 0.5)

png("../figures/simulation/aggregated_adjsd_subset.png", width = 1000, height = 400)
plot_grid(ggplot(data.frame(cbind(ts.param.ar2[subset_AR2, ], 
                                  sim.risk.ar.2.adjsd[subset_AR2, ])), 
                 aes(x = ac1, y = CED, group = factor(AR2))) + geom_line(aes(colour = AR2)) + theme_light() +
            xlab(expression(rho[1])) +
            scale_colour_gradient2(high="steelblue", mid="darksalmon"),
          ggplot(data.frame(cbind(ts.param.ma2[subset_MA2, ], 
                                  sim.risk.ma.2.adjsd[subset_MA2, ])), 
                 aes(x = ac1, y = CED, group = factor(MA2))) + geom_line(aes(colour = MA2)) + theme_light() +
            xlab(expression(rho[1])) +
            scale_colour_gradient2(high="steelblue", mid="darksalmon"),
          ggplot(data.frame(cbind(sim.risk.ar1.ma1.adjsd[subset_ARMA11, ], 
                                  ts.param.ar1.ma1[subset_ARMA11, ])), 
...
png("../figures/simulation/aggregated_adjsd.png", width = 1000, height = 400)
plot_grid(ggplot(data.frame(cbind(ts.param.ar2, 
                                  sim.risk.ar.2.adjsd)), 
                 aes(x = ac1, y = CED, group = factor(AR2))) + geom_line(aes(colour = AR2)) + theme_light() +
            xlab(expression(rho[1])) +
            scale_colour_gradient2(high="steelblue", mid="darksalmon"),
          ggplot(data.frame(cbind(ts.param.ma2, 
                                  sim.risk.ma.2.adjsd)), 
                 aes(x = ac1, y = CED, group = factor(MA2))) + geom_line(aes(colour = MA2)) + theme_light() +
            xlab(expression(rho[1])) +
            scale_colour_gradient2(high="steelblue", mid="darksalmon"),
          ggplot(data.frame(cbind(sim.risk.ar1.ma1.adjsd, 
                                  ts.param.ar1.ma1)), 
                 aes(x = ac1, y = CED, group = factor(MA1))) + geom_line(aes(colour = MA1)) + theme_light() +
            xlab(expression(rho[1]))+ 
            scale_colour_gradient2(mid="steelblue", low="darksalmon"),
